import 'package:ai_detects_diabetic_retinopathy/slider_form.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void _navigateToSliderForm(String userId, String jobTitle) {
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder:
            (context) => SliderFormPage(userId: userId, jobTitle: jobTitle),
      ),
    );
  }
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: const SizedBox(
                    width: 150.0,
                    height: 50.0,
                    child: Center(child: Text('Software Engineer')),
                  ),
                ),
                const SizedBox(height: 30.0),
                ElevatedButton(
                  ...
                  child: const SizedBox(
                    width: 150.0,
                    height: 50.0,
                    child: Center(child: Text('Health Services')),
                  ),
                ),
                const SizedBox(height: 30.0),
                ElevatedButton(
                  ...
                  child: const SizedBox(
                    width: 150.0,
                    height: 50.0,
                    child: Center(child: Text('Teaching')),
                  ),
                ),
              ],
            ),
